...
if [ "$3" = "mild-bottleneck" ] || [ "$3" = "severe-bottleneck" ] || [ "$3" = "recent-migration" ] || [ "$3" = "low-intensity-recombination-hotspot" ]; then
...
elif [ "$3" = "high-intensity-recombination-hotspot" ]; then
...
echo -e ""faster-nn-g-8"\t0\t0\t0\t$Inference_time\t$Success_rate\t$Success_rate_center\t$Success_rate_threshold\t$TPR" >> "$output_file"
