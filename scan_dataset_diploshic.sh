...
./grid -i $1 -m original -c bp -w $window_size -s 5000 -l $length -r 5 -g $grid_size -o "$output"window_"$window_size"/neut -p neut

./grid -i $2 -m original -c bp -w $window_size -s 5000 -l $length -r 5 -g $grid_size -o "$output"window_"$window_size"/sweep -p sweep
