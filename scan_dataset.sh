...
num_train=1000 # number of simulations of each class of training sets, note that the training sets should be balanced
...
#num_scan=100 # number of simulations for inference
error=0.01 # error
...
# Run RAiSD
	...
	python3 raisd_detection.py -n "$4" -d $3 -s $6 -l $length -e $error -T $tpr >> "$3"Results.txt
