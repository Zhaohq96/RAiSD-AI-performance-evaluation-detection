...
elif [ "$6" = "recent-migration-1K" ] || [ "$6" = "recent-migration-5K" ] || [ "$6" = "recent-migration-10K" ]; then
	rank=150
...
# Run diploSHIC
	...
	#echo "Success rate is:" >> "$4"Detection_result.txt
...
# Run T-REx
	...
	#echo "Success rate is:" >> "$4"Results/Results.txt
