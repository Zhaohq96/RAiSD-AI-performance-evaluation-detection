...
show_help() {
    echo "Usage of scan_dataset_faster-nn-g8.sh"
    echo
    echo "bash scan_dataset_faster-nn-g8.sh path_trained_model path_inference_folder path_output length target grid_size error run_ID"
    echo
