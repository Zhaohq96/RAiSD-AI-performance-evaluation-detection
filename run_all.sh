...
do
	...
	bash run_detection_all_tools.sh -d $dataset -g $grid -s $size --diploshic-model $DIPLOSHIC_MODEL --faster-nn-model $FASTER_NN_MODEL --faster-nn-g-8-model $FASTER_NN_G_8_MODEL
done 
